...
INSERT INTO "new_Transaction" ("amount", "category", "createdAt", "date", "description", "id", "updatedAt") SELECT "amount", "category", "createdAt", "date", "description", "id", "updatedAt" FROM "Transaction";
